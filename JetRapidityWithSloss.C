...
c1 = new TCanvas("c1","Fitting",5000,2000);
 ...
 c1->BuildLegend();
  ...
  Float_t a=f1->GetParameter("A");
  Float_t b=f1->GetParameter("B");
   Float_t c=f2->GetParameter("C");
   Float_t d=f2->GetParameter("D");
   ...
   //There are 6 data points from the PbPb data
    for(j=0;j<6;j++){
     ...
     Float_t Pbx=s1->GetX()[j];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pby=s1->GetY()[j];
     Float_t PPx=pow((Pby)/a,1/b);
   ...
   // 2nd part calculation
     ...
     for(i=0;i<2;i++){
     //  say that the transverse momemtum for PbPb data is Pbx
     Float_t Pbxx=s2->GetX()[i];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pbyy=s2->GetY()[i];
     Float_t PPxx=pow((Pbyy)/c,1/d);
...
sr1->SetMarkerStyle(20);
 ...
 c3->BuildLegend();
    ...
    c4= new TCanvas("c4","My Plots",5000,2000);
     ...
     //Get the parameters from previous fitting
  Float_t a=f3->GetParameter("A");
  Float_t b=f3->GetParameter("B");
   Float_t c=f4->GetParameter("C");
   Float_t d=f4->GetParameter("D");
   // Get PbPb data from the following file
   ...
   //There are 6 data points from the PbPb data
    for(j=0;j<6;j++){
     //  say that the transverse momemtum for PbPb data is Pbx
     Float_t Pbx=s3->GetX()[j];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pby=s3->GetY()[j];
     Float_t PPx=pow((Pby)/a,1/b);
   ...
   // 2nd part calculation
     ...
     for(i=0;i<3;i++){
     //  say that the transverse momemtum for PbPb data is Pbx
     Float_t Pbxx=s4->GetX()[i];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pbyy=s4->GetY()[i];
     Float_t PPxx=pow((Pbyy)/c,1/d);
...
sr2->SetMarkerStyle(20);
 ...
 c5->BuildLegend();
    ...
    c6= new TCanvas("c6","My Plots",5000,2000);
     ...
     //Get the parameters from previous fitting
  Float_t a=f5->GetParameter("A");
  Float_t b=f5->GetParameter("B");
   Float_t c=f6->GetParameter("C");
   Float_t d=f6->GetParameter("D");
   // Get PbPb data from the following file
   ...
   //There are 6 data points from the PbPb data
    for(j=0;j<6;j++){
     //  say that the transverse momemtum for PbPb data is Pbx
     Float_t Pbx=s5->GetX()[j];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pby=s5->GetY()[j];
     Float_t PPx=pow((Pby)/a,1/b);
   ...
   // 2nd part calculation
     ...
     for(i=0;i<3;i++){
     //  say that the transverse momemtum for PbPb data is Pbx
     Float_t Pbxx=s6->GetX()[i];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pbyy=s6->GetY()[i];
     Float_t PPxx=pow((Pbyy)/c,1/d);
...
sr3->SetMarkerStyle(20);
 ...
 c7->BuildLegend();
    ...
    c8= new TCanvas("c8","My Plots",5000,2000);
     ...
     //Get the parameters from previous fitting
  Float_t a=f7->GetParameter("A");
  Float_t b=f7->GetParameter("B");
  ...
  //Get PbPb data from the following file
   ...
   for(j=0;j<6;j++){
     //  say that the transverse momemtum for PbPb data is Pbx
     Float_t Pbx=s7->GetX()[j];
     //say that whatever value on the y axis for PbPb data is Pby
     Float_t Pby=s7->GetY()[j];
     Float_t PPx=pow((Pby)/a,1/b);
     //print out the corresponding transeverse momentum and the Sloss
     printf("%lf\t%lf\n",PPx,(PPx-Pbx)/PPx);
